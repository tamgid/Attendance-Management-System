...
if (isset($_POST['save'])) {
  ...
  $query = mysqli_query($conn, "SELECT * FROM course WHERE course_name ='$course_name' OR course_code = '$course_code'");
  $ret = mysqli_fetch_array($query);

  if ($ret > 0) {
    $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Class Already Exists!</div>";
  } else {
    $query = mysqli_query($conn, "INSERT INTO course (course_code, course_name) VALUES ('$course_code', '$course_name')");
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
  ...
  if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($conn, "UPDATE course SET course_code='$course_code', course_name='$course_name' WHERE Id='$Id'");
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h4 mb-0 text-gray-800">Create Courses</h1>
            <ol class="breadcrumb">
                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        ...
                        <input type="text" class="form-control" name="course_code" value="<?php echo $row['course_code']; ?>" placeholder="Course Code">
                      </div>
                      <div class="col-xl-6">
